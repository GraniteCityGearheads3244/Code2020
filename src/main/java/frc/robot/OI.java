...
import frc.util.AndJoystickButton;
import frc.util.AndNOTJoystickButton2;
import frc.util.JoystickAxisButton;
import frc.util.JoystickPOVButton;
import frc.util.OrJoystickButton;
...
public class OI {
    ...
    private void setUp_Controler_xBox_Driver(){
        ...
        l_Stick_Button_xbox_Driver.whenPressed(new MyDriveToggleShifter());
