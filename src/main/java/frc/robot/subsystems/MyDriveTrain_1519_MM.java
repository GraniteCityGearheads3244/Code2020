...
import frc.robot.Constants;
import frc.robot.Robot;
import frc.robot.commands.MyDriveWithJoystick;
 ...
 *
 *2018 Porting over to 2018 TalonFX
 *
 */
 ...
 *
 */
public class MyDriveTrain_1519_MM extends Subsystem {
	...
	private TalonFX left_TalonFX_follower1 = new TalonFX(14);
	//left_TalonFX_follower1 = new TalonFX(14);
	//addChild(left_TalonFX_follower1);
	private TalonFX left_TalonFX_follower2 = new TalonFX(15);
	//left_TalonFX_follower2 = new TalonFX(13);
	//addChild(left_TalonFX_follower2);
	private TalonFX left_TalonFX_Master = new TalonFX(13);
	//left_TalonFX_Master = new TalonFX(15);
	//addChild(left_TalonFX_Master);
	//private SpeedControllerGroup leftWheels = new SpeedControllerGroup(left_TalonFX_follower1, left_TalonFX_follower2 , left_TalonFX_Master );
	//leftWheels = new SpeedControllerGroup(left_TalonFX_follower1, left_TalonFX_follower2 , left_TalonFX_Master );
	//addChild(leftWheels);
	private TalonFX right_TalonFX_follower1 = new TalonFX(2);
	//right_TalonFX_follower1 = new TalonFX(1);
 	//addChild(right_TalonFX_follower1);
	private TalonFX right_TalonFX_Follower2 = new TalonFX(12);
	//right_TalonFX_Follower2 = new TalonFX(2);
	//addChild(right_TalonFX_Follower2);
	private TalonFX right_Talon_Master = new TalonFX(3);
	//right_Talon_Master = new TalonFX(0);
	//addChild(right_Talon_Master);
	//private SpeedControllerGroup rightWheels = new SpeedControllerGroup(right_TalonFX_follower1, right_TalonFX_Follower2 , right_Talon_Master );
	//rightWheels = new SpeedControllerGroup(right_TalonFX_follower1, right_TalonFX_Follower2 , right_Talon_Master );
 ...
 // member variables for Mecanum drive
 	...
 	private TalonFX[] m_talons = new TalonFX[kMaxNumberOfMotors];
    ...
    public MyDriveTrain_1519_MM() {
    	...
    	m_talons[kLeft] = left_TalonFX_Master;
    	m_talons[kRight] = right_Talon_Master;
		...
		for (talonIndex = 0; talonIndex < kMaxNumberOfMotors; talonIndex++) {
			...
			m_talons[talonIndex].configSelectedFeedbackSensor(FeedbackDevice.IntegratedSensor, 0, Constants.kTimeoutMs);
		}
		...
		left_TalonFX_follower1.follow(m_talons[kLeft]);
		left_TalonFX_follower2.follow(m_talons[kLeft]);
		right_TalonFX_follower1.follow(m_talons[kRight]);
		right_TalonFX_Follower2.follow(m_talons[kRight]);
    }
	...
	public void shiftHigh(){
		...
		right_Talon_Master.selectProfileSlot(0,0);
		left_TalonFX_Master.selectProfileSlot(0,0);
		m_kPIDLoopIdx = 0;
    ...
    public void shiftLow(){
		...
		right_Talon_Master.selectProfileSlot(1,0);
		left_TalonFX_Master.selectProfileSlot(1,0);
		m_kPIDLoopIdx = 1;
	...
	public void shiftMotinMagic(){
        ...
        dBL_Sol_Shifter.set(Value.kReverse);
		m_maxWheelSpeed_Current = m_maxWheelSpeed_HighGear;
		right_Talon_Master.selectProfileSlot(2,0);
		left_TalonFX_Master.selectProfileSlot(2,0);
		m_kPIDLoopIdx = 2;
