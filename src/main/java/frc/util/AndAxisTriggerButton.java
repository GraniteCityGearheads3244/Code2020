...
public class AndAxisTriggerButton extends Button {
	//Button Variables
    ...
    public AndAxisTriggerButton(GenericHID joystick1, int buttonNumber1, Joystick stick, Joystick.AxisType axis) {
    	this(joystick1, buttonNumber1,stick, axis, BOTH_WAYS);
    }
    
    public AndAxisTriggerButton(GenericHID joystick1, int buttonNumber1, Joystick stick, Joystick.AxisType axis, int direction) {
    ...
    public AndAxisTriggerButton(GenericHID joystick1, int buttonNumber1, Joystick stick, int axis) {
    	this(joystick1, buttonNumber1, stick, axis, BOTH_WAYS);
    }
    
    public AndAxisTriggerButton(GenericHID joystick1, int buttonNumber1, Joystick stick, int axis, int direction) {
    	this.joystick1 = joystick1;
        this.buttonNumber1 = buttonNumber1;
    	joystick = stick;
        this.axis = null;
